...
public class AuthenticationController {
  ...
  public String signUp(
    ...
    redirectAttributes.addFlashAttribute(
        ...
        messageSource.getMessage(
            "user.registration.verification.email.msg", null, LocaleContextHolder.getLocale()));
    ...
    try {
      ...
      if (isVerified) {
        ...
        redirectAttributes.addFlashAttribute(
            "expiredTokenError",
            messageSource.getMessage(
                "user.registration.verification.expired.token",
                null,
      ...
      e.printStackTrace();
      redirectAttributes.addFlashAttribute(
          ErrorConstant.INVALID_TOKEN_ERROR_ATR,
          messageSource.getMessage(
              ErrorConstant.VERIFICATION_INVALID_TOKEN_MSG_CODE,
              null,
              LocaleContextHolder.getLocale()));
      ...
      e.printStackTrace();
      redirectAttributes.addFlashAttribute(
          ErrorConstant.EMAIL_SERVICE_ERROR_ATR,
          messageSource.getMessage(
              ErrorConstant.EMAIL_SERVICE_ERROR_MSG_CODE, null, LocaleContextHolder.getLocale()));
    }
  ...
  public String forgotPassword(
      @Valid @ModelAttribute(ErrorConstant.RESET_PASSWORD_DATA_ATR)
    ...
    if (StringUtils.isEmpty(resetPasswordData.getEmail())) {
      model.addAttribute(
          "emptyEmailError",
          messageSource.getMessage(
              "user.reset.password.empty.email", null, LocaleContextHolder.getLocale()));
    ...
    redirectAttributes.addFlashAttribute(
        ...
        messageSource.getMessage(
            "user.forgot.password.message", null, LocaleContextHolder.getLocale()));
    return REDIRECT_LOGIN;
  }

  @GetMapping("/change/password")
  public String changePasswordTokenVerify(
  ...
  public String changePassword(
      ...
      RedirectAttributes redirectAttributes,
      final Model model) {
    if (StringUtils.isEmpty(resetPasswordData.getPassword())
        || StringUtils.isEmpty(resetPasswordData.getConfirmPassword())) {
      model.addAttribute(ErrorConstant.RESET_PASSWORD_DATA_ATR, resetPasswordData);
      model.addAttribute(
          "emptyFieldError",
          messageSource.getMessage(
              "user.reset.password.empty.field", null, LocaleContextHolder.getLocale()));
      return CHANGE_PASSWORD_PAGE;
    }
    if (!StringUtils.equals(
        resetPasswordData.getPassword(), resetPasswordData.getConfirmPassword())) {
      model.addAttribute(ErrorConstant.RESET_PASSWORD_DATA_ATR, resetPasswordData);
      model.addAttribute(
          "passwordMismatchError",
          messageSource.getMessage(
              "user.reset.password.mismatch", null, LocaleContextHolder.getLocale()));
      return CHANGE_PASSWORD_PAGE;
    }
    try {
    ...
    redirectAttributes.addFlashAttribute(
        ...
        messageSource.getMessage(
            "user.password.update.message", null, LocaleContextHolder.getLocale()));
    return REDIRECT_LOGIN;
  }
  ...
  public String getLoginPage(
    ...
    if (loginError) {
      model.addAttribute(
          "loginError",
          messageSource.getMessage("user.login.error", null, LocaleContextHolder.getLocale()));
    }
    if (invalidSession) {
      model.addAttribute(
          "invalidSession",
          messageSource.getMessage("user.invalid.session", null, LocaleContextHolder.getLocale()));
    }
    return LOGIN_PAGE;
  }
